      ...
      <div className="space-y-8">
        ...
        >
          <div className="px-5 py-4 flex items-center gap-3 border-b border-white/5">
            ...
            <h2 className="text-[11px] md:text-[16px] font-black text-white uppercase tracking-[0.2em]">Grand Prix</h2>
          </div>
          <div className="divide-y divide-white/[0.03]">
            {races?.map(r => (
              <button
                ...
                className={`w-full flex items-center gap-4 md:gap-5 px-5 py-2.5 md:px-7 md:py-4 text-left transition-all duration-150 ${
                  selectedRaceId === r.id
              ...
              >
                ...
                <span className="text-[9px] md:text-[13px] font-black text-primary/70 uppercase tracking-widest w-6 shrink-0">R{r.round}</span>
        ...
        >
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-xs md:text-lg font-black uppercase tracking-[0.2em] text-white flex items-center gap-2">
              <Users className="text-primary w-3.5 h-3.5" /> Scuderie
            </h2>
            <span className="px-2 py-0.5 bg-primary/10 rounded-full text-[7px] md:text-[12px] font-black text-primary tracking-widest border border-primary/20">
              {members?.length || 0}/10
            </span>
          </div>
